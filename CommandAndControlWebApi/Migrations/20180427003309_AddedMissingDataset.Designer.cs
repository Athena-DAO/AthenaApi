...
namespace CommandAndControlWebApi.Migrations
{
    ...
    [Migration("20180427003309_AddedMissingDataset")]
    partial class AddedMissingDataset
    {
            ...
            modelBuilder.Entity("CommandAndControlWebApi.Models.Pipeline", b =>
                {
                    ...
                    b.Property<Guid?>("GetCompleteDataSetId");
                    ...
                    b.HasIndex("GetCompleteDataSetId");
            ...
            modelBuilder.Entity("CommandAndControlWebApi.Models.Pipeline", b =>
                {
                    ...
                    b.HasOne("CommandAndControlWebApi.Models.CompleteDataSet", "GetCompleteDataSet")
                        .WithMany("Pipelines")
                        .HasForeignKey("GetCompleteDataSetId");
                });
